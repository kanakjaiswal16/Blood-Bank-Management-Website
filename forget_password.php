...
function sendemail_reset($email,$verified_token){
    ...
    <br/>
    <a href='http://localhost/practice/update_password.php?token=$verified_token'>Click to Reset Password </a>";
...
if(isset($_POST['submit'])){
    $email=$_POST['email'];
    $emailquery="SELECT * FROM donor_details where email='$email'";
